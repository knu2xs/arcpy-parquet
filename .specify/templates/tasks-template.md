...
**Tests**: Include test tasks whenever behavior changes. For this repository,
conversion and schema-impacting work is expected to include automated tests.
...
- [ ] T004 [P] Confirm code quality requirements (PEP8, type hints, docstrings)
  for touched modules
...
- [ ] T005 Define test coverage additions in `testing/` for changed behavior
- [ ] T006 [P] Identify ArcPy cursor/workspace performance constraints for the
  feature
- [ ] T007 [P] Identify reproducibility impacts on make targets/scripts/docs
- [ ] T008 Create base models/entities that all stories depend on
- [ ] T009 Configure error handling and logging infrastructure
- [ ] T010 Validate configuration and secret-handling changes
...
- [ ] TXXX Validate no secrets in tracked files and config samples
